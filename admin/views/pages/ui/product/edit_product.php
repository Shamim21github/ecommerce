...
*/
	if(count($errors)==0){
		...
		$product->category_id=$_POST["cmbProductCategoryId"];
...
<?php
	...
	$html.=select_field(["label"=>"Category","name"=>"cmbProductCategoryId","table"=>"product_categories","value"=>"$product->category_id"]);
