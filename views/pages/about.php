...
<head>
    ...
    <title>
        About Our Company | Intellect Software Ltd </title>
...
<body>
    ...
    <p>I throw myself down among the tall grass by the trickling stream; and, as I lie close to the earth, a thousand unknown plants are noticed by me: when I hear the buzz of the little world among the stalks, and grow familiar with the countless indescribable forms of the insects and flies, then I feel the presence of the Almighty, who formed us in his own image, and the breath.</p>
                ...
                <div class="col-md-6 animated triggerAnimation" data-animate="zoomIn">
                    <img src="./uploads/posts/1549220488.jpg" alt="About Us" />
                </div><!-- .col-md-6 end -->
            </div><!-- .row end -->
        </div><!-- .container end -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-3">
                            <div class="team-member">
                                                                <img src="./uploads/posts/15487911180.jpg" alt="Mohammad Towhidul Islam" />
                                                            <div class="team-details">
                                    <h5>Mohammad Towhidul Islam</h5>
                                    <p>Company founder</p>
                        ...
                        <div class="col-md-4 col-sm-3">
                            <div class="team-member">
                                                                <img src="./uploads/posts/15487911400.jpg" alt="JONATHAN BLUM" />
                                                            <div class="team-details">
                                    <h5>JONATHAN BLUM</h5>
                        ...
                        <div class="col-md-4 col-sm-3">
                            <div class="team-member">
                                                                <img src="./uploads/posts/15487911710.jpg" alt="TOM BECK" />
                                                            <div class="team-details">
                                    <h5>TOM BECK</h5>
